...
DEFAULT_CMAP = None
DEFAULT_COLOR = 'white'
DEFAULT_ROBUST_LIM_PCT = (5., 95.)
DEFAULT_WINDOW_SIZE = (1920, 1080)
TYPICAL_DPI = round(rcParams['figure.dpi'])
EMPIRICAL_DPI = 96
PXMM = 0.26458333333719

LAYER_CMAP_NEGATIVE_DEFAULT_VALUE = None
LAYER_CLIM_DEFAULT_VALUE = None
LAYER_CLIM_NEGATIVE_DEFAULT_VALUE = None
LAYER_CLIM_PERCENTILE_DEFAULT_VALUE = False
LAYER_COLOR_DEFAULT_VALUE = None
LAYER_COLOR_NEGATIVE_DEFAULT_VALUE = None
LAYER_ALPHA_DEFAULT_VALUE = 1.0
LAYER_ALPHA_NEGATIVE_DEFAULT_VALUE = None
LAYER_ALIM_DEFAULT_VALUE = None
LAYER_ALIM_NEGATIVE_DEFAULT_VALUE = None
LAYER_ALIM_PERCENTILE_DEFAULT_VALUE = False
LAYER_AMAP_DEFAULT_VALUE = None
LAYER_AMAP_NEGATIVE_DEFAULT_VALUE = None
LAYER_BELOW_COLOR_DEFAULT_VALUE = None
LAYER_NAN_OVERRIDE_DEFAULT_VALUE = (0, 0, 0, 0)
...
SURF_SCALARS_CLIM_DEFAULT_VALUE = None
...
NODE_RMAP_DEFAULT_VALUE = (2, 10)
NODE_RLIM_DEFAULT_VALUE = None
NODE_RLIM_PERCENTILE_DEFAULT_VALUE = False
NODE_COLOR_DEFAULT_VALUE = 'black'
NODE_CMAP_DEFAULT_VALUE = DEFAULT_CMAP
NODE_CLIM_DEFAULT_VALUE = None
NODE_CLIM_PERCENTILE_DEFAULT_VALUE = False
NODE_ALPHA_DEFAULT_VALUE = 1.0
NODE_AMAP_DEFAULT_VALUE = (0., 1.)
NODE_ALIM_DEFAULT_VALUE = None
NODE_ALIM_PERCENTILE_DEFAULT_VALUE = False

EDGE_RADIUS_DEFAULT_VALUE = 'edge_val'
EDGE_RMAP_DEFAULT_VALUE = (0.1, 1.8)
EDGE_RLIM_DEFAULT_VALUE = None
EDGE_RLIM_PERCENTILE_DEFAULT_VALUE = False
EDGE_COLOR_DEFAULT_VALUE = 'edge_sgn'
EDGE_CMAP_DEFAULT_VALUE = 'RdYlBu'
EDGE_CLIM_DEFAULT_VALUE = (-1, 1)
EDGE_CLIM_PERCENTILE_DEFAULT_VALUE = False
EDGE_ALPHA_DEFAULT_VALUE = 1.0
EDGE_AMAP_DEFAULT_VALUE = (0., 1.)
EDGE_ALIM_DEFAULT_VALUE = None
EDGE_ALIM_PERCENTILE_DEFAULT_VALUE = False
...
SCALAR_BAR_DEFAULT_NAME_SUFFIX = None
